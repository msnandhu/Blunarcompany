  ...
  const projects = [
    {
      ...
      image: '/innovative_decorator.png',
    ...
    },
    {
      ...
      category: 'Business Websites',
      image: '/metro_holidays_mockup.png',
    ...
    {
      id: 6,
      title: 'Anumirtha Bridal Studio',
      category: 'Business Websites',
      image: '/anumirtha_bridal.png',
      tech: ['React', 'Framer Motion', 'Tailwind'],
      url: 'https://anumirthabridal.com/',
    }
  ];
